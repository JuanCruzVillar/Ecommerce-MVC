...
namespace eCommerceMVC.Migrations
{
    ...
    [Migration("20251030014901_AgregarSistemaOfertas")]
    partial class AgregarSistemaOfertas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eCommerce.Entities.ConfiguracionPc", b =>
                {
                    ...
                    b.ToTable("CONFIGURACION_PC", (string)null);
                });

            modelBuilder.Entity("eCommerce.Entities.ConfiguracionPcDetalle", b =>
                {
                    b.Property<int>("IdDetalleConfiguracion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdDetalleConfiguracion"));
                    ...
                    b.HasKey("IdDetalleConfiguracion");

                    b.HasIndex("IdConfiguracion");

                    b.HasIndex("IdProducto");

                    b.ToTable("CONFIGURACION_PC_DETALLE", (string)null);
                });
            ...
            modelBuilder.Entity("eCommerce.Entities.Oferta", b =>
                {
            ...
            modelBuilder.Entity("eCommerce.Entities.ProductoEspecificacion", b =>
                {
            ...
            modelBuilder.Entity("eCommerce.Entities.ConfiguracionPcDetalle", b =>
                {
                    b.HasOne("eCommerce.Entities.ConfiguracionPc", "IdConfiguracionNavigation")
                        .WithMany("ConfiguracionesPcDetalles")
                    ...
                    b.Navigation("IdConfiguracionNavigation");
            ...
            modelBuilder.Entity("eCommerce.Entities.Oferta", b =>
                {
                    ...
                    b.HasOne("eCommerce.Entities.Producto", null)
                        .WithMany("Ofertas")
            ...
            modelBuilder.Entity("eCommerce.Entities.ProductoEspecificacion", b =>
                {
                    ...
                    b.HasOne("eCommerce.Entities.Producto", null)
                        .WithMany("ProductoEspecificaciones")
                        .HasForeignKey("ProductoIdProducto");
            ...
            modelBuilder.Entity("eCommerce.Entities.ConfiguracionPc", b =>
                {
                    b.Navigation("ConfiguracionesPcDetalles");
                });
            ...
            modelBuilder.Entity("eCommerce.Entities.Producto", b =>
                {
                    ...
                    b.Navigation("ProductoEspecificaciones");
                });
