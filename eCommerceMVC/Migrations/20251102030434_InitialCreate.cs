    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CONFIGURACION_PC", x => x.IdConfiguracion);
                    table.ForeignKey(
                        name: "FK_CONFIGURACION_PC_CLIENTE_IdClienteNavigationIdCliente",
            ...
            migrationBuilder.CreateTable(
                name: "CONFIGURACION_PC_DETALLE",
                columns: table => new
                {
                    IdDetalleConfiguracion = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdConfiguracion = table.Column<int>(type: "int", nullable: false),
                    IdProducto = table.Column<int>(type: "int", nullable: true),
                    ...
                    Subtotal = table.Column<decimal>(type: "decimal(10,2)", nullable: true, defaultValue: 0m),
                    FechaAgregado = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CONFIGURACION_PC_DETALLE", x => x.IdDetalleConfiguracion);
                    table.ForeignKey(
                        name: "FK_CONFIGURACION_PC_DETALLE_CONFIGURACION_PC_IdConfiguracion",
                        column: x => x.IdConfiguracion,
                        principalTable: "CONFIGURACION_PC",
                        principalColumn: "IdConfiguracion",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CONFIGURACION_PC_DETALLE_PRODUCTO_IdProducto",
                        column: x => x.IdProducto,
                        principalTable: "PRODUCTO",
                        principalColumn: "IdProducto",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PRODUCTO_ESPECIFICACION_PRODUCTO_ProductoIdProducto",
                        column: x => x.ProductoIdProducto,
                        principalTable: "PRODUCTO",
                        principalColumn: "IdProducto");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CONFIGURACION_PC_IdClienteNavigationIdCliente",
                table: "CONFIGURACION_PC",
                column: "IdClienteNavigationIdCliente");

            migrationBuilder.CreateIndex(
                name: "IX_CONFIGURACION_PC_DETALLE_IdConfiguracion",
                table: "CONFIGURACION_PC_DETALLE",
                column: "IdConfiguracion");

            migrationBuilder.CreateIndex(
                name: "IX_CONFIGURACION_PC_DETALLE_IdProducto",
                table: "CONFIGURACION_PC_DETALLE",
                column: "IdProducto");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PRODUCTO_ESPECIFICACION_ProductoIdProducto",
                table: "PRODUCTO_ESPECIFICACION",
                column: "ProductoIdProducto");
